...
}`;const M={PRIMARY1:new s("#2db987"),PRIMARY2:new s("#01b777"),PRIMARY3:new s("#00935F"),PRIMARY4:new s("#00935F"),PRIMARY5:new s("#00935F"),SECONDARY1:new s("#FFB03E"),SECONDARY2:new s("#FF9701"),SECONDARY3:new s("#DB8200"),SECONDARY4:new s("#B26900"),SECONDARY5:new s("#875000"),ACCENT1:new s("#EC3A66"),ACCENT2:new s("#EC013C"),ACCENT3:new s("#C80032"),ACCENT4:new s("#A20029"),ACCENT5:new s("#7B001F")},h=60;class oe{constructor(){t(this,"scene");t(this,"baseMat");t(this,"shadowMat");t(this,"mesh");const e=new z;this.scene=e.scene;const n=new _(1,1,10),i=new U;i.instanceCount=h*h,i.index=n.index,i.attributes=n.attributes;const v=new Float32Array(h*h*2),c=new Float32Array(h*h);let a=0;for(let l=0;l<h;l++)for(let m=0;m<h;m++)v[a*2+0]=l-h/2,v[a*2+1]=m-h/2,c[a]=Math.random(),a++;i.setAttribute("iXY",new A(v,2)),i.setAttribute("iRnd",new A(c,1));const u=new p({vertexShader:D,fragmentShader:te,glslVersion:I,uniforms:{uTime:{value:0},uLightPos:{value:null},uDepthMap:{value:null},uShadowPMat:{value:null},uShadowVMat:{value:null},uColor1:{value:M.PRIMARY2},uColor2:{value:M.ACCENT1}}});this.baseMat=u,this.shadowMat=new p({vertexShader:D,fragmentShader:ie,glslVersion:I,uniforms:{uTime:{value:0}}}),this.mesh=new y(i,u),this.scene.add(this.mesh)}update(e){this.shadowMat.uniforms.uTime.value+=1,this.baseMat.uniforms.uTime.value+=1,this.baseMat.uniforms.uLightPos.value=e.position,this.baseMat.uniforms.uShadowPMat.value=e.shadow.camera.projectionMatrix,this.baseMat.uniforms.uShadowVMat.value=e.shadow.camera.matrixWorldInverse}updateShadowMap(e){this.baseMat.uniforms.uDepthMap.value=e}setMat(e){e==="base"?this.mesh.material=this.baseMat:this.mesh.material=this.shadowMat}}const se={uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
