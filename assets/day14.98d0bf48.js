var k=Object.defineProperty;var I=(r,e,n)=>e in r?k(r,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):r[e]=n;var t=(r,e,n)=>(I(r,typeof e!="symbol"?e+"":e,n),n);import{d as f,K as R,M as y,I as U,q as _,e as q,G as C,D as T,Y as D,v as E,a4 as B,y as G,a1 as P,S as g,c as w,F as j,C as L,s as S,P as V,O as W,W as H}from"./three.module.9352233f.js";import{B as F,W as O}from"./cannon-es.4b49244b.js";import{O as Q}from"./OrbitControls.e80330a0.js";import"./stats.min.46d05fb3.js";import{D as $,t as N,S as Z}from"./three-to-cannon.modern.947aee40.js";import{F as K}from"./FXAAShader.0b4b74a1.js";class X{constructor(){t(this,"ui");t(this,"stats")}begin(){this.stats&&this.stats.begin()}end(){this.stats&&this.stats.end()}}class Y{constructor(){t(this,"scene");t(this,"mesh");const e=new m;this.scene=e.scene3;const n=new f(2,2),s=new R({map:null});this.mesh=new y(n,s),this.mesh.position.z=-1,this.scene.add(this.mesh)}setTexture(e){this.mesh.material.map=e}}var J=`uniform sampler2D uTexture;
...
}`;const p=2,x=2,re=100;class ie{constructor(){t(this,"scene");t(this,"items",[]);const e=new m;this.scene=e.scene3;const n=[...new Array(re)].map(()=>[Math.random()*p,Math.random()*x]),a=$.from(n).voronoi([0,0,p,x]);let c=0;const l=[];for(;;){const v=a.cellPolygon(c);if(v[0][0]==null)break;c++,l.push(v)}const i=new q({vertexShader:se,fragmentShader:oe,glslVersion:C,uniforms:{uMap:{value:null},uMatrix:{value:null},uOpacity:{value:1}},side:T,opacity:0,transparent:!0,wireframe:!1});l.forEach(v=>{v.shift();const u=this.makeGeom(v),d=new y(u.geom,i);d.position.x+=u.x-p/2,d.position.y+=u.y-x/2,this.scene.add(d);const o=N(d,{type:Z.HULL}).shape,h=new F({mass:1});h.addShape(o),h.angularVelocity.set(3,2,u.y),h.angularDamping=.8,e.physics.addBody(h),this.items.push({mesh:d,body:h,origin:{position:d.position.clone(),quaternion:d.quaternion.clone()}})}),this.apply()}setTexture(e){this.items.forEach(n=>{n.mesh.material.uniforms.uMap.value=e})}update(){this.items.forEach(e=>{e.mesh.position.set(e.body.position.x,e.body.position.y,e.body.position.z),e.mesh.quaternion.set(e.body.quaternion.x,e.body.quaternion.y,e.body.quaternion.z,e.body.quaternion.w)})}reset(){this.items.forEach(e=>{e.mesh.position.set(e.origin.position.x,e.origin.position.y,e.origin.position.z),e.mesh.quaternion.set(e.origin.quaternion.x,e.origin.quaternion.y,e.origin.quaternion.z,e.origin.quaternion.w),e.body.velocity.setZero(),e.body.position.set(e.mesh.position.x,e.mesh.position.y,e.mesh.position.z),e.body.quaternion.set(e.mesh.quaternion.x,e.mesh.quaternion.y,e.mesh.quaternion.z,e.mesh.quaternion.w)})}start(e,n){this.items.forEach(s=>{s.body.velocity.setZero();const a=s.mesh.position,c=100;s.body.angularDamping=1,s.body.angularVelocity.set((a.x-e)*c,(a.y-n)*c,0)})}apply(){this.items.forEach(e=>{e.body.position.set(e.mesh.position.x,e.mesh.position.y,e.mesh.position.z),e.body.quaternion.set(e.mesh.quaternion.x,e.mesh.quaternion.y,e.mesh.quaternion.z,e.mesh.quaternion.w)})}makeGeom(e){const n=new G,s=[],a=[],c=[],l=.01,i=e.length,v=e.reduce((o,h)=>[o[0]+h[0],o[1]+h[1]],[0,0]),u=v[0]/i,d=v[1]/i;e.forEach(o=>{s.push(o[0]-u,o[1]-d,-l),a.push(o[0]/p,o[1]/x)}),e.forEach(o=>{s.push(o[0]-u,o[1]-d,l),a.push(o[0]/p,o[1]/x)});for(let o=1;o<i-1;o++)c.push(0,o,o+1);for(let o=1;o<i-1;o++)c.push(0+i,o+i,i+o+1);for(let o=0;o<i;o++){const h=o,z=(o+1)%i;c.push(h,z,h+i),c.push(z,z+i,h+i)}return n.setAttribute("position",new P(new Float32Array(s),3)),n.setAttribute("uv",new P(new Float32Array(a),2)),n.setIndex(c),{geom:n,x:u,y:d}}renderVoronoi(e){const n=document.createElement("canvas");document.body.appendChild(n),n.style.backgroundColor="#ccc",n.width=p,n.height=x;const s=n.getContext("2d");s.beginPath(),e.render(s),s.lineWidth=.25,s.strokeStyle="#ff0000",s.fillStyle="#ffff33",s.stroke()}}class ae{constructor(){t(this,"scene");t(this,"camera");t(this,"renderer");t(this,"mesh");const e=new m;this.scene=new g,this.camera=e.oCamera,this.renderer=e.renderer;const n=new f(2,2),s=new q({...K});this.mesh=new y(n,s),this.mesh.material.uniforms.resolution.value.x=1/(window.innerWidth*this.renderer.getPixelRatio()),this.mesh.material.uniforms.resolution.value.y=1/(window.innerHeight*this.renderer.getPixelRatio()),this.scene.add(this.mesh)}render(e,n){this.renderer.setRenderTarget(e),this.mesh.material.uniforms.tDiffuse.value=n,this.renderer.render(this.scene,this.camera),this.renderer.setRenderTarget(null)}}var ce=`uniform float uTime;
